...
from serial import *                                  # add Serial library for serial communication
import time
import pyautogui                                   # add pyautogui library for programmatically controlling the mouse and keyboard.

Arduino_Serial = Serial('COM3',9600)       # Initialize serial and Create Serial port object called Arduino_Serial
